...
@Component({
  selector: 'app-figura-didactica-cara-papa-pre',
  templateUrl: './figura-didactica-cara-papa-pre.component.html',
  styleUrls: ['./figura-didactica-cara-papa-pre.component.css']
})
export class FiguraDidacticaCaraPapaPreComponent {
  ...
  agregarAlCarrito(): void {
      ...
      const producto = {
        ...
        sku: 'F9408',
        precio: '$24.990', 
        imagen: 'assets/imgPreescolar/cara-de-papa/01.jpg'
      };
  ...
  imagenes: string[] = [
    'assets/imgPreescolar/cara-de-papa/01.jpg',
    'assets/imgPreescolar/cara-de-papa/02.jpg',
    'assets/imgPreescolar/cara-de-papa/03.jpg'
  ];
