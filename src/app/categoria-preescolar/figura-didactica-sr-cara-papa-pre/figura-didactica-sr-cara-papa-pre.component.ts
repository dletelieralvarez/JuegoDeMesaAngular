...
@Component({
  selector: 'app-figura-didactica-sr-cara-papa-pre',
  templateUrl: './figura-didactica-sr-cara-papa-pre.component.html',
  styleUrls: ['./figura-didactica-sr-cara-papa-pre.component.css']
})
export class FiguraDidacticaSrCaraPapaPreComponent {
  ...
  imagenes: string[] = [
    'assets/imgPreescolar/sr-cara-de-papa/01.jpg',
    'assets/imgPreescolar/sr-cara-de-papa/02.jpg',
    'assets/imgPreescolar/sr-cara-de-papa/03.jpg'
  ];
