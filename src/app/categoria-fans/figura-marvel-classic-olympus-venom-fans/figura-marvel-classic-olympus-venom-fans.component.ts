...
@Component({
  selector: 'app-figura-marvel-classic-olympus-venom-fans',
  templateUrl: './figura-marvel-classic-olympus-venom-fans.component.html',
  styleUrls: ['./figura-marvel-classic-olympus-venom-fans.component.css']
})
export class FiguraMarvelClassicOlympusVenomFansComponent {
  ...
  imagenes: string[] = [
    'assets/imgFans/figura-marvel-classic-olympus-venom/01.jpg',
    'assets/imgFans/figura-marvel-classic-olympus-venom/02.jpg',
    'assets/imgFans/figura-marvel-classic-olympus-venom/03.jpg'
  ];
