...
@Component({
  selector: 'app-lanzador-nerf-nseries-shadow-storm-kids',
  templateUrl: './lanzador-nerf-nseries-shadow-storm-kids.component.html',
  styleUrls: ['./lanzador-nerf-nseries-shadow-storm-kids.component.css']
})
export class LanzadorNerfNSeriesShadowStormKidsComponent {
  ...
  imagenes: string[] = [
    'assets/imgKids/lanzador-nerf-n-series-shadow-storm/01.jpg',
    'assets/imgKids/lanzador-nerf-n-series-shadow-storm/02.jpg',
    'assets/imgKids/lanzador-nerf-n-series-shadow-storm/03.jpg'
  ];
